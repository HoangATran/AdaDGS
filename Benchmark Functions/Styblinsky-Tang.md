...
- Global minimum: <img src="https://latex.codecogs.com/svg.latex?&space;f(\mathbf{x}_{opt})=-39.166d" title=" "/> &nbsp; at &nbsp; <img src="https://latex.codecogs.com/svg.latex?&space;{x}_{opt}=(-2.903534,\cdots,2.903534)" title=" "/>.
