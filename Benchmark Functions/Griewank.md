...
<div align="center"> <img src="https://latex.codecogs.com/svg.latex?&space;f(\mathbf{x})=\sum_{i=1}^d\sum_{k=0}^{kmax}a^k\cos(2\pi{b^k}(x_i+0.5))-d\sum_{k=0}^{kmax}a^k\cos(\pi{b^k})," title="Griewank" /> </div>
...
<div align="center"> 
  <img src="image/Griewank.jpg" alt="Griewank" height="400"/> 
  <! <img src="image/griewank_error_plot.jpg" alt="error" height="380"/> 
</div>
