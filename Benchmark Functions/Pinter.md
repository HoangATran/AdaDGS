...
<div align="center"> <img src="https://latex.codecogs.com/svg.latex?&space;f(\mathbf{x})=\sum_{i=1}^d\sum_{k=0}^{kmax}a^k\cos(2\pi{b^k}(x_i+0.5))-d\sum_{k=0}^{kmax}a^k\cos(\pi{b^k})," title="Pinter" /> </div>
...
<div align="center"> 
  <img src="image/Pinter.jpg" alt="Pinter" height="400"/> 
  <! <img src="image/pinter_error_plot.jpg" alt="error" height="380"/> 
</div>
