...
The initial search domain <img src="https://latex.codecogs.com/svg.latex?&space;x\in[-32.768,32.768]^d" title=" "/>. The global minimum is <img src="https://latex.codecogs.com/svg.latex?&space;f(x_{opt})=0" title=" "/>.
