...
<div align="center"> <img src="https://latex.codecogs.com/svg.latex?&space;f(\mathbf{x})=-a\exp\Biggl(-b\sqrt{\frac{1}{d}\sum_{i=1}^d{x_i^2}}\Biggl)-\exp\Biggl(\frac{1}{d}\sum_{i=1}^d\cos(c{x_i})\Biggl)+a+\exp(1)" title="Ackley" /> </div>
