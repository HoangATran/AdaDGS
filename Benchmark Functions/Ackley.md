...
The initial search domain is <img src="https://latex.codecogs.com/svg.latex?&space;x" title=" "/>. The global minimum is <img src="https://latex.codecogs.com/svg.latex?&space;f(x_{opt})=0" title=" "/>.
