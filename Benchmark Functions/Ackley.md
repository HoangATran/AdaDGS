...
- Global minimum: <img src="https://latex.codecogs.com/svg.latex?&space;f(\mathbf{x}_{opt})=0," title=" "/> at <img src="https://latex.codecogs.com/svg.latex?&space;f({x}_{opt})=(0,\ldots,0)/>."
